...
FILENAME="${1:?usage: $0 <validator.json|peer-geo.json|evidence.json|cycle-history.jsonl|<16-64hex>.ics>}"
...
case "$FILENAME" in
  validator.json|peer-geo.json|uptime-recent.json|uptime-cycles.json|peers.json|peers-changes.json|peers-gini.json|peers-gini-history.jsonl|peers-history-index.json|fee-market.json|fee-market-history.jsonl|node-health-recent.json|evidence.json|cycle-history.jsonl)
